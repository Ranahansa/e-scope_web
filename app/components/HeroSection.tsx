...
const HeroSection: React.FC = () => {
    ...
    return (
        <div ref={headerRef} className="large-header relative flex flex-col items-center justify-center min-h-screen text-white text-center px-4 sm:px-8 bg-[#000040] overflow-hidden">
